...
-- AddForeignKey
ALTER TABLE "Prompt_variables" ADD CONSTRAINT "Prompt_variables_prompt_version_id_fkey" FOREIGN KEY ("prompt_version_id") REFERENCES "Prompt_versions"("id") ON DELETE SET NULL ON UPDATE CASCADE;

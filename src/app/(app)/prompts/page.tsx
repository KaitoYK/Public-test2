          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b bg-muted/50">
                <th className="px-5 py-3 text-left font-semibold text-muted-foreground uppercase tracking-wider">Title</th>
                <th className="px-5 py-3 text-left font-semibold text-muted-foreground uppercase tracking-wider">Category</th>
                <th className="px-5 py-3 text-left font-semibold text-muted-foreground uppercase tracking-wider">Status</th>
                <th className="px-5 py-3 text-left font-semibold text-muted-foreground uppercase tracking-wider">Updated</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border">
              {loading ? (
                ...
                <tr>
                  <td colSpan={4} className="px-5 py-12 text-center text-muted-foreground border-dashed">
                ...
                prompts.map((p) => (
                  <tr key={p.id} className="hover:bg-muted/30 transition-colors">
                    <td className="px-5 py-4">
                      <Link href={`/prompts/${p.id}`} className="font-medium text-foreground hover:text-primary transition-colors flex flex-col gap-1">
                        {p.title}
                        <span className="text-xs font-normal text-muted-foreground bg-muted w-max px-1.5 py-0.5 rounded border">
